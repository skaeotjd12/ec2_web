...
<form>
		<div class="form-group">
			...
			<input type="hidden" class="form-control" placeholder="Enter userid" id="userId" readonly="readonly" value="${principal.user.userId}">
		...
		<div class="mb-3">
				...
				<input class="form-control"  id="userBirth" type="date" readonly="readonly">
